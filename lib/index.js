...
module.exports = class extends Generator {
  ...
  */
  ...
  writing() {
    ...
    if (this.shouldRun === 'main') {
      this.fs.copyTpl(this.templatePath('./class/Class.php'), this.destinationPath(`./src/${this.props.className}.php`), this.props );
      ...
      this.fs.copyTpl(this.templatePath('./class/Test.php'), this.destinationPath(`./tests/Unit/Test${this.props.className}.php`), this.props );
    }
  }
